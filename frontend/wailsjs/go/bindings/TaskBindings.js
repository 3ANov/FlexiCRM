...
export function Create(arg1) {
  return window['go']['bindings']['TaskBindings']['Create'](arg1);
}

export function Delete(arg1, arg2) {
  return window['go']['bindings']['TaskBindings']['Delete'](arg1, arg2);
}

export function GetAll() {
  return window['go']['bindings']['TaskBindings']['GetAll']();
}
